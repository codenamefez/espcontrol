...
| Media | media | media_player | Yes | Own picker item | Type: play_pause, previous, next, volume, position, now_playing, control_modal; Type: default, state; Controls: default, progress, play_pause; Maximum Volume: 1-100; Label Display: label, status; Top Left Display: icon, volume; Large Media Numbers | Visible |
